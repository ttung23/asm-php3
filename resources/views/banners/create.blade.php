    ...
    <div style="margin-left: 300px" class="container mt-2">
        ...
        <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>banner img:</strong>
                        <input type="file" name="img" class="form-control" placeholder="Banner img">
                        @error('img')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="active" class="form-control" placeholder="Banner active">
                        @error('active')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
